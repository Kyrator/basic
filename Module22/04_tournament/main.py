...
with open('first_tour.txt', 'r', encoding='UTF-8') as file_input:
...
with open('second_tour.txt', 'w', encoding='UTF-8') as file_output:
    all_second_tour = 0
    position = 0
...
with open('second_tour.txt', 'r', encoding='UTF-8') as file_input:
